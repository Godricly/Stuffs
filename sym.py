...
def fc_module(data, prefix, num_hidden=256):
    with mx.name.Prefix(prefix):
        ...
        #fc2 = mx.sym.FullyConnected(data=relu_fc1, num_hidden=num_hidden, name='fc2')
        #relu_fc2 = mx.sym.Activation(data=fc2, act_type='relu', name='relu_fc2')
        return data# Darelu_fc1



def sym_gen(tc_length, cc_length, tw_length, cw_length,
            num_hidden = 256, num_layers=1, num_class=2000):
